...
var museumicon=L.icon({
  iconUrl: 'pic/museumicon.png',
  iconSize: [30, 30], // size of the icon
});

var wineryicon=L.icon({
  iconUrl: 'pic/wineryicon.png',
  iconSize: [30, 30], // size of the icon
});
...
var kerinon_omoiomaton = L.marker([40.887, 24.202], {
    icon: museumicon,
    title: "Μουσείο"
  }).bindPopup("<h6>Μουσείο</br>Κέρινων Ομοιωμάτων</h6><img src=pic/mouseio_omoiomaton.png width=150 height=100> </br> "),
  laografiko_ladia = L.marker([40.946, 24.001], {
    icon: museumicon,
    title: "Μουσείο"
  }).bindPopup("<h6>Λαογραφικό μουσείο</br>Χαγιάτι Λαδιά</h6><img src=pic/mouseio_ladia.png width=150 height=100> </br> "),
  laografiko_mesoropis = L.marker([40.863, 24.080], {
    icon: museumicon,
    title: "Μουσείο"
  }).bindPopup("<h6>Λαογραφικό μουσείο</br>Μεσορόπης</h6><img src=pic/mouseio_mesoropis.png width=150 height=100> </br> "),
  art_gallery = L.marker([40.848, 24.067], {
    icon: museumicon,
    title: "Μουσείο"
  }).bindPopup("<h6>Πινακοθήκη</br>Μαγικό βουνό</h6><img src=pic/art_gallery.png width=150 height=100> </br> ")

var mouseia= L.layerGroup([kerinon_omoiomaton, laografiko_ladia, laografiko_mesoropis, art_gallery]).addTo(map);

var biblia_chora = L.marker([40.810, 23.990], {
    icon: wineryicon,
    title: "Οινοποιείο"
  }).bindPopup("<h6>Κτήμα</br>Βίβλια Χώρα</h6><img src=pic/ktima_biblia_chora.png width=150 height=100> </br> "),
  mackedon_winery = L.marker([40.85, 24.069], {
    icon: wineryicon,
    title: "Οινοποιείο"
  }).bindPopup("<h6>Οινοποιείο</br>Μακεδών</h6><img src=pic/oinopoiio_makedon.png width=150 height=100> </br> ")

var winery= L.layerGroup([biblia_chora, mackedon_winery]).addTo(map);
